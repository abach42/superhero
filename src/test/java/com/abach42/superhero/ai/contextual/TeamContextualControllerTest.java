...
class TeamContextualControllerTest {
    ...
    void shouldDelegateToService() {
        ...
        SuperheroRagTeamDto expected = new SuperheroRagTeamDto("rescue", List.of(TestStubs.getSuperheroShortDtoStub()), "ok");
        given(teamContextualService.generateTeamByRag("rescue", 5)).willReturn(expected);
