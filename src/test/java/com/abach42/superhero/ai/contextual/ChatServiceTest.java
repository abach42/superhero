...
class ChatServiceTest {
    ...
    void shouldGenerateTeamResponseText() {
        ...
        given(promptService.generateContextualPrompt("Rescue city", 5, "Candidate profile"))
                .willReturn(teamPrompt);
        given(chatClient.prompt(teamPrompt).call().chatResponse().getResult().getOutput().getText())
                .willReturn("{\"team\":[1],\"explanation\":\"ok\"}");
