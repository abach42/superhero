 ...
 * <br>
 * This class provides a {@link Bean} for the configured {@link ObjectMapper},
 * `superheroObjectMapper`, which can be injected and used in tests to ensure consistent
 * serialization behavior, especially for sensitive data such as passwords.
 * <p>
 * Usage:
 * <br>
