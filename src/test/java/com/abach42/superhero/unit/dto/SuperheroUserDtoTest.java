...
public class SuperheroUserDtoTest {
    ...
    void getRoleFromStringThrowsExceptionForInvalidRole() {
        assertThrows(IllegalArgumentException.class, () -> SuperheroUserDto.RoleEnum.getFromString("invalid_role"));
    }
    ...
    public void testPasswordIsHidden() throws JsonProcessingException {
        ...
        SuperheroUserDto failingUserDto = new SuperheroUserDto("foo", "this password is written but not read", "bar");
